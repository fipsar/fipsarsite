...
const DELIVERABLES: DeliverableItem[] = [
  ...
  },
  {
    ...
    description: "User-friendly analytics tools give teams independent access to insights without relying on technical support. This encourages a stronger data-driven culture and empowers decision-makers across the organization.",
...
export const Business: React.FC<SliderProps> = () => {
...
{/*             
            ...
            <h2 className="text-3xl md:text-4xl lg:text-4xl font-bold  mb-6 leading-tight">
             Turn Complex Data <br className="hidden md:block"/>
              {/* <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600"> */}
               into Clear Insights
              {/* </span> */}
            </h2>
